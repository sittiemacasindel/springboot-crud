...
public class ImportDataResponseDTO {
    ...
    // Constructors
    public ImportDataResponseDTO() {
    }

    public ImportDataResponseDTO(Long dataId, Integer number, String offeringDept, String subject, 
                                 String subjectTitle, Integer creditedUnits, String section, 
                                 String schedule, String room, Integer totalSlots, Integer enrolled, 
                                 Integer assessed, String isClosed) {
        this.dataId = dataId;
        this.number = number;
